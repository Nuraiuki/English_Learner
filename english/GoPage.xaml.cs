...
namespace english
{
    public partial class GoPage : ContentPage
    {
        public GoPage()
        {
            ...
            List<PhrasalVerb> goPhrasalVerbs = DatabaseManager.GetPhrasalVerbsStartingWithFromDatabase("go");

            // Привязываем список к CarouselView
            goCarousel.ItemsSource = goPhrasalVerbs;
        }
        ...
        private async void LearnButton_Clicked(object sender, EventArgs e)
        {
            ...
            PhrasalVerb selectedVerb = goCarousel.CurrentItem as PhrasalVerb;
